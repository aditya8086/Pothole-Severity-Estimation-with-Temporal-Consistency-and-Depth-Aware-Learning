...
img = Image.open(folder_dir + image_directory[0]).convert("RGB")
...
image = Image.open(folder_dir + image_directory[0]).convert("RGB")
...
### save Depth images into folder
cv2.imwrite(folder_depth + image_directory[0], depth_image)

######### Point cloud filtering and display
# outliers removal
